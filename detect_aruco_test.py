      ...
      for (marker_corner, marker_id) in zip(corners, ids):
        ...
        if image_flag:
          ...
          try:
              ...
              if marker_id == 5:
                overlay_test_1 = cv2.imread('data/test_1.png')
                overlay_test_1 = cv2.resize(overlay_test_1, dim, interpolation = cv2.INTER_AREA)

                empty[:height, :width] = overlay_test_1
                ...
                overlay_test_2 = cv2.imread('data/test_2.png')
                overlay_test_2 = cv2.resize(overlay_test_2, dim, interpolation = cv2.INTER_AREA)

                empty[:height, :width] = overlay_test_2
                _inp = np.float32([[0, 0], [width, 0], [width, height], [0, height]])
                _out = np.float32([top_left, top_right, bottom_right, bottom_left])
                M = cv2.getPerspectiveTransform(_inp, _out)
                transformed = cv2.warpPerspective(empty, M, (bW, bH))
                ...
                overlay_test_3 = cv2.imread('data/test_3.png')
                overlay_test_3 = cv2.resize(overlay_test_3, dim, interpolation = cv2.INTER_AREA)

                empty[:height, :width] = overlay_test_3
                _inp = np.float32([[0, 0], [width, 0], [width, height], [0, height]])
                _out = np.float32([top_left, top_right, bottom_right, bottom_left])
                M = cv2.getPerspectiveTransform(_inp, _out)
                transformed = cv2.warpPerspective(empty, M, (bW, bH))
                ...
                overlay_test_4 = cv2.imread('data/test_4.png')
                overlay_test_4 = cv2.resize(overlay_test_4, dim, interpolation = cv2.INTER_AREA)

                empty[:height, :width] = overlay_test_4
                _inp = np.float32([[0, 0], [width, 0], [width, height], [0, height]])
                _out = np.float32([top_left, top_right, bottom_right, bottom_left])
                M = cv2.getPerspectiveTransform(_inp, _out)
                transformed = cv2.warpPerspective(empty, M, (bW, bH))
